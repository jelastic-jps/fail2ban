...
command -v python3 >/dev/null 2>&1 || yum -y install python3
if grep -a 'AlmaLinux' /etc/system-release ; then rpm -q  python3-setuptools || microdnf -y install python3-setuptools; fi
