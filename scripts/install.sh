...
if [ ! -f /etc/init.d/fail2ban ] ; then cp ./files/redhat-initd /etc/init.d/fail2ban ; chmod u+x,g+x,o+x /etc/init.d/fail2ban ; chkconfig --add --level 345 fail2ban; chkconfig  fail2ban on ; fi
