...
echo "PATH=$(whereis fail2ban-client | awk -F ':' '{print $2}' | awk -F "/fail2ban-client" '{print $1}' | cut -c 2-)" >> ~/.profile && echo "export PATH" >> ~/.profile
echo "PATH=$(whereis fail2ban-client | awk -F ':' '{print $2}' | awk -F "/fail2ban-client" '{print $1}' | cut -c 2-)" >> ~/.bash_profile && echo "export PATH" >> ~/.bash_profile
